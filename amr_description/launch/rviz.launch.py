...
def generate_launch_description():
	...
	xacro_path = os.path.join(get_package_share_directory('amr_description'), 'urdf', 'amr.xacro')
	...
	rviz = Node(
		...
		name='rviz2',
		output='screen',
		arguments=['-d', os.path.join(get_package_share_directory('amr_description'), 'rviz', 'entire_setup.rviz')]
	)
